...
Repositório desenvolvido para fins educativos, não sou um desenvolvedor (ainda) **Aprendendo sobre Python & PowerBI, Especialista em Infraestrutura em Cloud (AWS, AZURE e GCP), usando Git e GitHub**.
